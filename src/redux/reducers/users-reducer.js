...
export const setTotalUsersCount = (totalUsersCount) => ({ type: SET_TOAL_USERS_COUNT, count: totalUsersCount });
export const setIsFetching = (isFetching) => ({ type: SET_IS_FETCHING_LOADER, isFetching });
